   ...
   <div class="p-4  border-gray-200 rounded-lg dark:border-gray-700 mt-14">
     <div class="alumni-id">
        ...
        <div class="title bg-sky-900 mb-5 p-5 rounded-lg shadow-2xl">
                  ...
                  <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">ADD</span>Alumni ID</h1>
