                  ...
                  <div class="event-form bg-emerald-50 p-5 rounded-lg shadow-2xl">
                     ...
                     <?php
                      ...
                      if(isset($_POST["title"]) && isset($_FILES["eventPhoto"]) && isset($_POST["des"]) && isset($_POST["date"])){
                        ...
                        if(mysqli_query($connect,$dataSet)){
                           echo "Data Inserted";
                        }else{
                     ...
                     <form class="mx-auto" action="add_events.php" method="POST" enctype="multipart/form-data"> 
                        ...
                        <input class="block w-full  bg-gray-50 text-sm text-gray-900 border border-gray-300 rounded-lg  cursor-pointer dark:text-gray-400 focus:outline-none " aria-describedby="user_avatar_help" name="eventPhoto" id="user_avatar" type="file">
