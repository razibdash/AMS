            ...
            <div class="seccess">
               <div class="add-seccess">
                  <div class="title bg-sky-900 mb-5 p-5 rounded-lg shadow-2xl">
                     ...
                     <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Add Success</span>Story</h1>
                  ...
                  <div class="succes-form bg-emerald-50 p-5 rounded-lg shadow-2xl">
                     ...
                     <form class="mx-auto" action="add_success_story.php" method="POST" enctype="multipart/form-data"> 
                        ...
                        <input type="text" id="title" name="full_name"  class="rounded-lg bg-gray-50 border border-gray-300 text-gray-900 w-full focus:ring-blue-500 p-2.5" placeholder="event title" requied>
