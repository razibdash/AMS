            ...
            <div class="events">
               <div class="add-event">
                  <div class="title bg-sky-900 mb-5 p-5 rounded-lg shadow-2xl">
                     ...
                     <p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">University events can include academic ceremonies, social events, employee recognition celebrations, conferences, and high-level meetings</p>
